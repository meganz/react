...
(function(global, factory) {
  ...
  function dispatchEventForPluginEventSystem(
    ...
    batchedUpdates(() => {
      var targetInst = ancestorInst,
        ...
        dispatchQueue = [],
        dispatchQueue$jscomp$0 = dispatchQueue;
      a: {
        ...
        if (void 0 !== reactName) {
          ...
          inCapturePhase = inCapturePhase
            ...
            : reactName;
          for (
            var listeners$jscomp$0 = [],
              instance$jscomp$0 = targetInst,
              lastHostComponent;
            null !== instance$jscomp$0;

          ) {
            const { stateNode, tag } = instance$jscomp$0;
            if (
              5 === tag &&
              null !== stateNode &&
              ((lastHostComponent = stateNode), null !== inCapturePhase)
            ) {
              var listener$jscomp$0 = getListener(
                instance$jscomp$0,
                inCapturePhase
              );
              null != listener$jscomp$0 &&
                listeners$jscomp$0.push(
            ...
            instance$jscomp$0 = instance$jscomp$0.return;
          }
          JSCompiler_inline_result = listeners$jscomp$0;
      ...
      if (0 === (eventSystemFlags & 7)) {
        a: {
          ...
          if (reactEventType || SyntheticEventCtor) {
            ...
            if (reactEventType) {
              if (
                ...
                (reactName = reactName
                  ...
                  : null),
                null !== reactName &&
                  ((JSCompiler_inline_result = getNearestMountedFiber(
                    reactName
                  )),
            ...
            if (reactEventType !== reactName) {
              ...
              listener$jscomp$0 = "onMouseLeave";
              listeners$jscomp$0 = "onMouseEnter";
              instance$jscomp$0 = "mouse";
              if (
                "pointerout" === domEventName ||
                "pointerover" === domEventName
              )
                (inCapturePhase = SyntheticPointerEvent),
                  (listener$jscomp$0 = "onPointerLeave"),
                  (listeners$jscomp$0 = "onPointerEnter"),
                  (instance$jscomp$0 = "pointer");
              ...
              listener$jscomp$0 = null;
              getClosestInstanceFromNode(nativeEventTarget) === targetInst &&
                ((inCapturePhase = new inCapturePhase(
                  listeners$jscomp$0,
                  instance$jscomp$0 + "enter",
                  reactName,
                  nativeEvent,
                  nativeEventTarget
                )),
                ...
                (listener$jscomp$0 = inCapturePhase));
              JSCompiler_inline_result = listener$jscomp$0;
              if (reactEventType && reactName)
                b: {
                  inCapturePhase = reactEventType;
                  listeners$jscomp$0 = reactName;
                  instance$jscomp$0 = 0;
                  for (
                  ...
                  lastHostComponent = 0;
                  for (
                    listener$jscomp$0 = listeners$jscomp$0;
                    listener$jscomp$0;
                    listener$jscomp$0 = getParent(listener$jscomp$0)
                  )
                    lastHostComponent++;
                  for (; 0 < instance$jscomp$0 - lastHostComponent; )
                    (inCapturePhase = getParent(inCapturePhase)),
                      instance$jscomp$0--;
                  for (; 0 < lastHostComponent - instance$jscomp$0; )
                    (listeners$jscomp$0 = getParent(listeners$jscomp$0)),
                      lastHostComponent--;
                  for (; instance$jscomp$0--; ) {
                    if (
                      inCapturePhase === listeners$jscomp$0 ||
                      (null !== listeners$jscomp$0 &&
                        inCapturePhase === listeners$jscomp$0.alternate)
                    )
                      break b;
                    inCapturePhase = getParent(inCapturePhase);
                    listeners$jscomp$0 = getParent(listeners$jscomp$0);
        ...
        a: {
          SyntheticEventCtor = targetInst
            ...
            : window;
          reactEventType = SyntheticEventCtor;
          reactName =
            reactEventType.nodeName && reactEventType.nodeName.toLowerCase();
          if (
            (reactEventType =
              "select" === reactName ||
              ("input" === reactName && "file" === reactEventType.type))
          )
            ...
            isTextInputElement(SyntheticEventCtor)
              ...
              : ((reactEventType = SyntheticEventCtor),
                (reactEventType =
                  (reactName = reactEventType.nodeName) &&
                  "input" === reactName.toLowerCase() &&
                  ("checkbox" === reactEventType.type ||
                    "radio" === reactEventType.type)) &&
      ...
      for (
        getTargetInstFunc = 0;
        getTargetInstFunc < dispatchQueue$jscomp$0.length;
        getTargetInstFunc++
      ) {
        const { event, listeners } = dispatchQueue$jscomp$0[getTargetInstFunc];
        SyntheticEventCtor = void 0;
        dispatchQueue = event;
        targetInst = listeners;
        if (nativeEventTarget)
          for (
            reactEventType = targetInst.length - 1;
            0 <= reactEventType;
            reactEventType--
          ) {
            const { instance, currentTarget, listener } = targetInst[
              reactEventType
            ];
            if (
              instance !== SyntheticEventCtor &&
              dispatchQueue.isPropagationStopped()
            )
              break;
            executeDispatch(dispatchQueue, listener, currentTarget);
            SyntheticEventCtor = instance;
          }
        else
          for (
            reactEventType = 0;
            reactEventType < targetInst.length;
            reactEventType++
          ) {
            const { instance, currentTarget, listener } = targetInst[
              reactEventType
      ...
      if (hasRethrowError)
        throw ((dispatchQueue$jscomp$0 = rethrowError),
        (hasRethrowError = !1),
        (rethrowError = null),
        dispatchQueue$jscomp$0);
    });
  ...
  function getMaskedContext(workInProgress, unmaskedContext) {
    {
      ...
      instance &&
        ...
        (workInProgress.__reactInternalMemoizedMaskedChildContext = contextTypes));
      return context;
    }
  }
  ...
  function pushTreeId(workInProgress, totalChildren, index) {
    ...
    index += 1;
    baseIdWithLeadingBit = 32 - clz32(totalChildren) + baseLength;
    if (30 < baseIdWithLeadingBit) {
      ...
      totalChildren = 32 - clz32(totalChildren) + baseLength;
      workInProgress = baseIdWithLeadingBit + workInProgress;
      treeContextId = (1 << totalChildren) | (index << baseLength) | baseId;
      treeContextOverflow = workInProgress;
    } else (treeContextId = (1 << baseIdWithLeadingBit) | (index << baseLength) | baseId), (treeContextOverflow = workInProgress);
  }
  ...
  function deleteHydratableInstance(returnFiber, instance) {
    var JSCompiler_inline_result = createFiber(5, null, null, 0);
    JSCompiler_inline_result.elementType = "DELETED";
    JSCompiler_inline_result.stateNode = instance;
    JSCompiler_inline_result.return = returnFiber;
    instance = returnFiber.deletions;
    null === instance
      ? ((returnFiber.deletions = [JSCompiler_inline_result]),
        (returnFiber.flags |= 16))
      : instance.push(JSCompiler_inline_result);
  }
  ...
  function enqueueUpdate(fiber, update, lane) {
    ...
    return (fiber = markUpdateLaneFromFiberToRoot(fiber, lane));
  }
  ...
  function updateMemoComponent(
    ...
    if (null === current) {
      var type = Component.type,
        type$jscomp$0 = type;
      if (
        "function" === typeof type$jscomp$0 &&
        !shouldConstruct(type$jscomp$0) &&
        void 0 === type$jscomp$0.defaultProps &&
    ...
    type$jscomp$0 = current.child;
    if (
      0 === (current.lanes & renderLanes) &&
      ((type = type$jscomp$0.memoizedProps),
      (Component = Component.compare),
      (Component = null !== Component ? Component : shallowEqual),
      Component(type, nextProps) && current.ref === workInProgress.ref)
    )
      return bailoutOnAlreadyFinishedWork(current, workInProgress, renderLanes);
    workInProgress.flags |= 1;
    current = createWorkInProgress(type$jscomp$0, nextProps);
    current.ref = workInProgress.ref;
    current.return = workInProgress;
    return (workInProgress.child = current);
  }
    ...
    switch (workInProgress.tag) {
      ...
      case 5:
        ...
        if (null !== current && null != workInProgress.stateNode)
          ...
          if (popHydrationState(workInProgress)) {
            ...
            newProps[internalPropsKey] = current;
            ...
            switch (type) {
              ...
              case "details":
                ...
                break;
              case "input":
                initWrapperState(newProps, current);
                listenToNonDelegatedEvent("invalid", newProps);
                break;
              case "select":
                newProps._wrapperState = { wasMultiple: !!current.multiple };
                listenToNonDelegatedEvent("invalid", newProps);
                break;
              case "textarea":
                initWrapperState$2(newProps, current),
                  listenToNonDelegatedEvent("invalid", newProps);
            }
            assertValidProps(type, current);
            rootContainerInstance = null;
            for (var propKey in current)
              current.hasOwnProperty(propKey) &&
                ((currentHostContext = current[propKey]),
                "children" === propKey
                  ? "string" === typeof currentHostContext
                    ? newProps.textContent !== currentHostContext &&
                      (!0 !== current.suppressHydrationWarning &&
            ...
            switch (type) {
              case "input":
                track(newProps);
                postMountWrapper(newProps, current, !0);
                break;
              case "textarea":
                track(newProps);
              ...
              case "option":
                break;
              default:
                "function" === typeof current.onClick &&
            ...
            "http://www.w3.org/1999/xhtml" === rootContainerInstance &&
              (rootContainerInstance = getIntrinsicNamespace(current));
            if ("http://www.w3.org/1999/xhtml" === rootContainerInstance) {
              if ("script" === current) throw Error(current);
              "string" === typeof newProps.is
                ? (propKey = propKey.createElement(current, {
                    is: newProps.is
                  }))
                : ((propKey = propKey.createElement(current)),
                  "select" === current &&
              ...
              propKey = propKey.createElementNS(rootContainerInstance, current);
            current = propKey;
            ...
            a: {
              currentHostContext = isCustomComponent(renderLanes, newProps);
              switch (renderLanes) {
                case "dialog":
              ...
              propKey = rootContainerInstance;
              for (type in propKey) {
                if (!propKey.hasOwnProperty(type)) continue;
                const nextProp = propKey[type];
                "style" === type
                  ...
                  : "suppressContentEditableWarning" !== type &&
                    ...
                    "autoFocus" !== type &&
                    (registrationNameDependencies.hasOwnProperty(type)
                      ? null != nextProp &&
                        "onScroll" === type &&
              ...
              switch (renderLanes) {
                ...
                case "select":
                  ...
                  type = newProps.value;
                  null != type
                    ? updateOptions(current, !!newProps.multiple, type, !1)
      ...
      case 6:
        if (current && null != workInProgress.stateNode)
          ...
          if (popHydrationState(workInProgress)) {
            newProps = workInProgress.stateNode;
            type = workInProgress.memoizedProps;
            current = newProps;
            renderLanes = type;
            current[internalInstanceKey] = workInProgress;
            if ((current = current.nodeValue !== renderLanes))
              if (((renderLanes = hydrationParentFiber), null !== renderLanes))
                switch (renderLanes.tag) {
                  case 3:
                    checkForUnmatchedText(
                      newProps.nodeValue,
                      type,
                      0 !== (renderLanes.mode & 1)
                    );
                    break;
                  case 5:
                    !0 !== renderLanes.memoizedProps.suppressHydrationWarning &&
                      checkForUnmatchedText(
                        newProps.nodeValue,
                        type,
                        0 !== (renderLanes.mode & 1)
      ...
      case 13:
        ...
        if (
          ...
          if (
            ...
            ((propKey = popHydrationState(workInProgress)),
      ...
      case 19:
                ...
                if (null !== propKey) {
                  ...
                  for (current = workInProgress.child; null !== current; )
                    (type = current),
                      ...
                      (type.flags &= 14680066),
                      (propKey = type.alternate),
                      null === propKey
                        ? ((type.childLanes = 0),
                          (type.lanes = renderLanes),
                          (type.child = null),
                          (type.subtreeFlags = 0),
                          ...
                          (type.stateNode = null))
                        : ((type.childLanes = propKey.childLanes),
                          (type.lanes = propKey.lanes),
                          (type.child = propKey.child),
                          (type.subtreeFlags = 0),
                          (type.deletions = null),
                          (type.memoizedProps = propKey.memoizedProps),
                          (type.memoizedState = propKey.memoizedState),
                          (type.updateQueue = propKey.updateQueue),
                          (type.type = propKey.type),
                          (renderLanes = propKey.dependencies),
                          (type.dependencies =
                            null === renderLanes
                              ? null
                              : {
        ...
        if (null !== type.tail)
          return (
            ...
            (type = suspenseStackCursor.current),
            (type = newProps ? (type & 1) | 2 : type & 1),
            push(suspenseStackCursor, type),
            workInProgress
          );
        bubbleProperties(workInProgress);
        return null;
  ...
  function commitBeforeMutationEffects(root, firstChild) {
    ...
    if (hasSelectionCapabilities(root)) {
      var JSCompiler_temp = root;
      if ("selectionStart" in JSCompiler_temp)
        JSCompiler_temp = {
          start: JSCompiler_temp.selectionStart,
          end: JSCompiler_temp.selectionEnd
        };
      else
        a: {
          var { ownerDocument } = JSCompiler_temp;
          ownerDocument =
            (ownerDocument && ownerDocument.defaultView) || window;
          if (
            (ownerDocument =
              ownerDocument.getSelection && ownerDocument.getSelection()) &&
            0 !== ownerDocument.rangeCount
          ) {
            var {
              anchorNode,
              anchorOffset,
              ...
              b: for (;;) {
                ...
                for (;;) {
                  node !== anchorNode ||
                    ...
                    (start = ownerDocument + anchorOffset);
                  node !== focusNode ||
                    (0 !== focusOffset && 3 !== node.nodeType) ||
                    (end = ownerDocument + focusOffset);
                  3 === node.nodeType &&
                    (ownerDocument += node.nodeValue.length);
                  if (null === (next = node.firstChild)) break;
                  parentNode = node;
                  node = next;
                }
                for (;;) {
                  if (node === JSCompiler_temp) break b;
    ...
    if (flags & 2) {
      try {
        ...
        switch (JSCompiler_inline_result.tag) {
          ...
          case 3:
          case 4: {
            const parent = JSCompiler_inline_result.stateNode.containerInfo,
  ...
  function commitLayoutEffects_begin(subtreeRoot, root, committedLanes) {
    ...
    for (; null !== nextEffect; ) {
      ...
      var firstChild$jscomp$0 = fiber.child;
      if (22 === fiber.tag && isModernRoot) {
        ...
        if (!newOffscreenSubtreeIsHidden) {
          ...
          if (
            ...
            for (
              newOffscreenSubtreeIsHidden = nextEffect = fiber;
              null !== nextEffect;

            ) {
              newOffscreenSubtreeWasHidden = nextEffect;
              const firstChild = newOffscreenSubtreeWasHidden.child;
              22 === newOffscreenSubtreeWasHidden.tag &&
              null !== newOffscreenSubtreeWasHidden.memoizedState
                ? reappearLayoutEffects_complete(newOffscreenSubtreeIsHidden)
                : null !== firstChild
                ? ((firstChild.return = newOffscreenSubtreeWasHidden),
                  (nextEffect = firstChild))
                : reappearLayoutEffects_complete(newOffscreenSubtreeIsHidden);
            }
          for (; null !== firstChild$jscomp$0; )
            (nextEffect = firstChild$jscomp$0),
              commitLayoutEffects_begin(
                firstChild$jscomp$0,
                root,
                committedLanes
              ),
              (firstChild$jscomp$0 = firstChild$jscomp$0.sibling);
          nextEffect = fiber;
        ...
        0 !== (fiber.subtreeFlags & 8772) && null !== firstChild$jscomp$0
          ? ((firstChild$jscomp$0.return = fiber),
            (nextEffect = firstChild$jscomp$0))
  ...
  function commitLayoutMountEffects_complete(
    ...
    for (; null !== nextEffect; ) {
      ...
      if (0 !== (root.flags & 8772)) {
        ...
        try {
          var current$jscomp$0 = committedLanes;
          committedLanes = root;
          if (0 !== (committedLanes.flags & 8772))
            switch (committedLanes.tag) {
              ...
              case 15:
                ...
                break;
              case 1: {
                const instance = committedLanes.stateNode;
                if (committedLanes.flags & 4 && !offscreenSubtreeWasHidden)
                  if (null === current$jscomp$0) instance.componentDidMount();
                  else {
                    const prevProps =
                ...
                const updateQueue = committedLanes.updateQueue;
                null !== updateQueue &&
                ...
                if (null !== updateQueue) {
                  ...
                  if (null !== committedLanes.child)
                    switch (committedLanes.child.tag) {
                      case 5:
                        current$jscomp$0 = committedLanes.child.stateNode;
                        break;
                      case 1:
                        current$jscomp$0 = committedLanes.child.stateNode;
                    }
              ...
              case 5: {
                const instance = committedLanes.stateNode;
                if (null === current$jscomp$0 && committedLanes.flags & 4) {
                  current$jscomp$0 = instance;
                  ...
                  switch (committedLanes.type) {
                    ...
                    case "select":
                    case "textarea":
                      newProps.autoFocus && current$jscomp$0.focus();
                      break;
                    case "img":
                      newProps.src && (current$jscomp$0.src = newProps.src);
                  }
                }
                break;
              }
              ...
              case 13:
                if (null === committedLanes.memoizedState) {
                  const current = committedLanes.alternate;
                  if (null !== current) {
          ...
          offscreenSubtreeWasHidden ||
            (committedLanes.flags & 512 && commitAttachRef(committedLanes));
        } catch (error) {
    ...
    for (; null !== nextEffect; ) {
      ...
      try {
        ...
        switch (node.tag) {
          ...
          case 15:
            var current = node,
              nearestMountedAncestor = node.return;
            try {
      ...
      try {
        ...
        a: {
          ...
          if (
            ...
            const suspenseBoundary = getNearestSuspenseBoundaryToCapture(
              returnFiber
            );
  ...
  function performUnitOfWork(unitOfWork) {
    let next;
    next = beginWork$1(unitOfWork.alternate, unitOfWork, subtreeRenderLanes);
      ...
      try {
        ...
        if (null === rootWithPendingPassiveEffects)
          ...
          for (nextEffect = priority.current; null !== nextEffect; ) {
            const fiber$jscomp$0 = nextEffect;
            var child$jscomp$0 = fiber$jscomp$0.child;
            if (0 !== (nextEffect.flags & 16)) {
              var deletions = fiber$jscomp$0.deletions;
              if (null !== deletions) {
                for (let i = 0; i < deletions.length; i++) {
                  const fiberToDelete = deletions[i];
                  for (
                    var deletedSubtreeRoot = (nextEffect = fiberToDelete),
                      nearestMountedAncestor = fiber$jscomp$0;
                    null !== nextEffect;

                  ) {
                    var fiber$jscomp$1 = nextEffect;
                    switch (fiber$jscomp$1.tag) {
                      case 0:
                      case 11:
                      case 15:
                    ...
                    const child = fiber$jscomp$1.child;
                    if (null !== child)
                      (child.return = fiber$jscomp$1), (nextEffect = child);
                    else
                      for (
                        fiber$jscomp$1 = deletedSubtreeRoot;
                        null !== nextEffect;
                ...
                {
                  const previousFiber = fiber$jscomp$0.alternate;
                ...
                nextEffect = fiber$jscomp$0;
              }
            }
            if (
              0 !== (fiber$jscomp$0.subtreeFlags & 2064) &&
              null !== child$jscomp$0
            )
              ...
              b: for (; null !== nextEffect; ) {
                deletedSubtreeRoot = nextEffect;
                if (0 !== (deletedSubtreeRoot.flags & 2048))
                  switch (deletedSubtreeRoot.tag) {
                    case 0:
                    case 11:
                    case 15:
                      commitHookEffectListUnmount(
                        9,
                        deletedSubtreeRoot,
                        deletedSubtreeRoot.return
                      );
                  }
                const sibling = deletedSubtreeRoot.sibling;
                if (null !== sibling) {
                  sibling.return = deletedSubtreeRoot.return;
                  nextEffect = sibling;
                  break b;
                }
                nextEffect = deletedSubtreeRoot.return;
              }
          }
          var finishedWork = priority.current;
          for (nextEffect = finishedWork; null !== nextEffect; ) {
            child$jscomp$0 = nextEffect;
            const firstChild = child$jscomp$0.child;
            if (
              0 !== (child$jscomp$0.subtreeFlags & 2064) &&
              null !== firstChild
            )
              (firstChild.return = child$jscomp$0), (nextEffect = firstChild);
            else
              b: for (child$jscomp$0 = finishedWork; null !== nextEffect; ) {
  ...
  function legacyRenderSubtreeIntoContainer(
    ...
    } else root = legacyCreateRootFromDOMContainer(container, children, parentComponent, callback, forceHydrate);
  ...
  const mediaEventTypes = "abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(
      " "
    ),
  ...
  const NO_CONTEXT = {},
    ...
    workInProgressSources = [],
    {
      ...
      ReactCurrentBatchConfig: ReactCurrentBatchConfig$2
    } = ReactSharedInternals;
  let renderLanes = 0,
  ...
  updateHostComponent$1 = function(
    ...
    if (oldProps !== newProps) {
      ...
      requiredContext(contextStackCursor$1.current);
      {
        ...
        let styleName;
        type = null;
        for (updatePayload in oldProps)
          if (
            !newProps.hasOwnProperty(updatePayload) &&
            oldProps.hasOwnProperty(updatePayload) &&
            null != oldProps[updatePayload]
          )
            if ("style" === updatePayload) {
              var lastStyle = oldProps[updatePayload];
              for (styleName in lastStyle)
                lastStyle.hasOwnProperty(styleName) &&
                  (type || (type = {}), (type[styleName] = ""));
            } else
              "children" !== updatePayload &&
                "suppressContentEditableWarning" !== updatePayload &&
                "suppressHydrationWarning" !== updatePayload &&
                "autoFocus" !== updatePayload &&
                (registrationNameDependencies.hasOwnProperty(updatePayload)
                  ? rootContainerInstance || (rootContainerInstance = [])
                  : (rootContainerInstance = rootContainerInstance || []).push(
                      updatePayload,
                      null
                    ));
        for (updatePayload in newProps) {
          lastStyle = newProps[updatePayload];
          const lastProp = null != oldProps ? oldProps[updatePayload] : void 0;
          if (
            newProps.hasOwnProperty(updatePayload) &&
            lastStyle !== lastProp &&
            ...
            if ("style" === updatePayload)
              if (lastProp) {
                ...
                type ||
                  (rootContainerInstance || (rootContainerInstance = []),
                  rootContainerInstance.push(updatePayload, type)),
                  (type = lastStyle);
            else
              "children" === updatePayload
                ...
                : "suppressContentEditableWarning" !== updatePayload &&
                  ...
                  (registrationNameDependencies.hasOwnProperty(updatePayload)
                    ? (null != lastStyle &&
                        "onScroll" === updatePayload &&
                        listenToNonDelegatedEvent("scroll", current),
                      rootContainerInstance ||
                        lastProp === lastStyle ||
                        (rootContainerInstance = []))
                    : (rootContainerInstance =
                        rootContainerInstance || []).push(
                        updatePayload,
                        lastStyle
                      ));
        }
        ...
        var updatePayload = rootContainerInstance;
      }
  ...
  beginWork$1 = function(current, workInProgress, renderLanes) {
    ...
    switch (workInProgress.tag) {
      ...
      case 10:
        a: {
          nextState = workInProgress.type._context;
          Component = workInProgress.pendingProps;
          ...
          hasId = newValue;
          push(valueCursor, context._currentValue);
          context._currentValue = hasId;
          if (null !== oldProps)
            if (objectIs(oldProps.value, newValue)) {
              if (
                oldProps.children === Component.children &&
                !didPerformWorkStackCursor.current
              ) {
                workInProgress = bailoutOnAlreadyFinishedWork(
                  current,
              ...
              for (
                ...
                oldProps = hasId.dependencies;
                if (null !== oldProps)
                  for (
                    nextState = hasId.child, newValue = oldProps.firstContext;
                    null !== newValue;

                  ) {
                    if (newValue.context === context) {
                      if (1 === hasId.tag) {
                        newValue = createUpdate(-1, renderLanes & -renderLanes);
                        newValue.tag = 2;
                        ...
                        if (null !== updateQueue) {
                          ...
                          null === pending
                            ...
                            : ((newValue.next = pending.next),
                              (pending.next = newValue));
                          updateQueue.pending = newValue;
                        }
                      }
                      hasId.lanes |= renderLanes;
                      newValue = hasId.alternate;
                      null !== newValue && (newValue.lanes |= renderLanes);
                  ...
                  oldProps = nextState.alternate;
                  null !== oldProps && (oldProps.lanes |= renderLanes);
                  scheduleContextWorkOnParentPath(
                    nextState,
                    renderLanes,
                    workInProgress
  ...
  exports.createRoot = function(container, options) {
    {
      ...
      container = new ReactDOMRoot(options);
    }
    return container;
  };
  ...
  exports.hydrateRoot = function(container, initialChildren, options) {
    {
      ...
      var JSCompiler_inline_result =
        (null != options && options.hydratedSources) || null;
      var isStrictMode = !1,
        identifierPrefix = "";
      ...
      if (JSCompiler_inline_result)
        for (
          isStrictMode = 0;
          isStrictMode < JSCompiler_inline_result.length;
          isStrictMode++
        )
          (container = initialChildren),
            (options = JSCompiler_inline_result[isStrictMode]),
      ...
      JSCompiler_inline_result = new ReactDOMHydrationRoot(initialChildren);
    }
    return JSCompiler_inline_result;
  };
